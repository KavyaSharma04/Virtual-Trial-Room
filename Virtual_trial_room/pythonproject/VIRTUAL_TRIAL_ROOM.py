...
main_frame = cv2.imread("C:\\Users\\HP\\Desktop\\Virtual_trial_room\\pythonproject\\Original_Image.jpg")
...
def F1():
    ...
    design = cv2.imread("C:\\Users\\HP\\Desktop\\Virtual_trial_room\\pythonproject\\Trial_TShirt1.jpg")
...
def F2():
    cv2.imshow('Orignal_Image', main_frame)
    design = cv2.imread("C:\\Users\\HP\\Desktop\\Virtual_trial_room\\pythonproject\\Trial_TShirt2.jpg")
    design = cv2.resize(design, mask_black.shape[ 1::-1 ])
